...
const SvgComment = ({className="", label="Comment", nav=false}) => {
    return (
        <svg className={(nav ? 'navSvg ' : '') + `defaultSvg ${className}`} width="204" height="132" viewBox="0 0 204 132" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label={label}>
