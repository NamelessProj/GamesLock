...
const SvgShare = ({className="", label="Share", nav=false}) => {
    return (
        <svg className={(nav ? 'navSvg ' : '') + `defaultSvg ${className}`} width="217" height="174" viewBox="0 0 217 174" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label={label}>
