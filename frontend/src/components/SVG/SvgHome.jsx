...
const SvgHome = ({className="", label="Home", nav=false}) => {
    return (
        <svg className={(nav ? 'navSvg ' : '') + `defaultSvg ${className}`} width="104" height="129" viewBox="0 0 104 129" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label={label}>
