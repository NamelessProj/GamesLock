...
const SvgBell = ({label="Notifications"}) => {
    return (
        <svg className="defaultSvg" width="346" height="432" viewBox="0 0 346 432" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label={label}>
