...
const SvgBell = ({className="", label="Notifications", nav=false}) => {
    return (
        <svg className={(nav ? 'navSvg ' : '') +  `defaultSvg ${className}`} width="346" height="432" viewBox="0 0 346 432" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label={label}>
