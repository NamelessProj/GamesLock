const createOTP = (numOfDigits=6) => {
    const digits = numOfDigits > 17 ? 16 : numOfDigits - 1; // Limit the number of digits to 17, since it's the number of digits Math.random can generate. And soustract 1
